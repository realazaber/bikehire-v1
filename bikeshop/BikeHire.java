...
public class BikeHire {
	...
	private void listAvailableBikes(){ //Shows all AVAILABLE BIKES
	...
	private void saveRentals(){
		...
		try{
			_file = new FileOutputStream("rentals.dat");
			_output = new ObjectOutputStream(_file);
	    
			for(RentRecord _rent: _rents){
				_output.writeObject(_rent);
			}
		}
		catch(Exception e){
			System.err.println("Error: " + e.getMessage());
		...
		System.out.println("Rent records saved to HTML file g aye.");
	}
		...
		try{
			...
			while(_flag){
				System.out.println("\n1. View available bikes\n" +
									...
									"6. Add a rent record\n" +
									"7. Show all rentals\n" +
									"8. Show rentals by customer ID\n" +
									"9. Save rent records to file\n" +
									"10. Read rent records from file\n" +
									"11. Display overdue rents\n" +
									"12. Add bike\n" +
									"13. Quit"); 
